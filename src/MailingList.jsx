...
export default function MailingList({ token, setToken, Frame, API, navigate, mode }) {
  ...
  return <Frame token={token} setToken={setToken} eyebrow="Community updates" title={title}
    ...
    {!mode && <>
      ...
      <div className="admin-list"><div className="admin-list-heading"><h2>{page.total} contacts</h2><button className="text-button" disabled={busy} onClick={() => load()}>Refresh</button></div>
